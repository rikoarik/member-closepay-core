...
export const HomeScreen = () => {
  ...
  // Ensure activeTab is set to tab with order 2 when tabs are ready (only once)
  useEffect(() => {
    if (!hasSetInitialTabRef.current && tabs.length >= 2) {
    ...
    } else if (!hasSetInitialTabRef.current && tabs.length > 0) {
