...
```json
{
  "my-company": {
    ...
    "packageName": "com.closepay.mycompany",
...
**Note:** 
- `packageName` is **user input** (NOT auto-generated)
- `logoPath` is optional (can be relative path or URL)
- Colors come from backend, not from config
