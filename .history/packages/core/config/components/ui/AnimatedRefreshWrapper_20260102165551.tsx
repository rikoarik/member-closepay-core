...
import { scale, moderateVerticalScale, moderateScale } from '../../utils/responsive';
...
export const AnimatedRefreshWrapper: React.FC<AnimatedRefreshWrapperProps> = ({
  ...
  const handleScroll = useCallback(
    ...
    [refreshing, onRefresh, pullDistance, rotation, scaleAnim, opacity, scrollViewProps]
  );
  ...
  }, [refreshing, pullDistance, rotation, scaleAnim, opacity]);
  ...
  const contentTranslateY = pullDistance.interpolate({
    ...
    function VerticalScale(arg0: number): number | undefined {
